...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // 음식 카테고리 관련 에러
    FOOD_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "FOOD_CATEGORY404", "해당하는 음식 카테고리가 없습니다."),

    // 가게 관련 에러
    STORE_NOT_FOUND(HttpStatus.NOT_FOUND, "STORE404", "가게를 찾을 수 없습니다."),

    // 미션 관련 에러
    MISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "MISSION404", "해당하는 미션을 찾을 수 없습니다."),

    // 멤버 미션 관련 에러
    IS_ALREADY_ON_GOING(HttpStatus.BAD_REQUEST, "MEMBER_MISSION400", "회원이 이미 진행 중인 미션 입니다.");
